...
| Tests                          | `pi/.pi/agent/extensions/**/*.test.ts`, `pi/.local/bin/tdd-plan.test.ts`, `pi/.local/bin/lib/`, `obsidian/.local/lib/wiki-search/wiki-search.test.ts`, `obsidian/.local/lib/wiki-core/`, `obsidian/.local/lib/issue/` |
